...
namespace objdump.Instructions {
    ...
    // 1001 001r rrrr 0001
    public class stzp: IInstruction {

        public OpInfo info;
        public OpInfo OpInfo { get { return info; } }

        public stzp() { info = new OpInfo( "ST", "Store Indirect From Register to Data Space using Index Z",
            new Regex( @"1001001\d{5}0001", RegexOptions.Compiled ) ); }
