...
namespace objdump.Instructions {
    ...
    // 1001 000d dddd 1001
    public class ldyp: IInstruction {

        public OpInfo info;
        public OpInfo OpInfo { get { return info; } }

        public ldyp() { info = new OpInfo( "LD", "Load Indirect from Data Space to Register using Index Y",
            new Regex( @"1001000\d{5}1001", RegexOptions.Compiled ) ); }
