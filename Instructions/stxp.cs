...
namespace objdump.Instructions {
    ...
    // 1001 001r rrrr 1101
    public class stxp: IInstruction {

        public OpInfo info;
        public OpInfo OpInfo { get { return info; } }

        public stxp() { info = new OpInfo( "ST", "Store Indirect From Register to Data Space using Index X",
            new Regex( @"1001001\d{5}1101", RegexOptions.Compiled ) ); }
