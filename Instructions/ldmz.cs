...
namespace objdump.Instructions {
    ...
    // 1001 000d dddd 0010
    public class ldmz: IInstruction {

        public OpInfo info;
        public OpInfo OpInfo { get { return info; } }

        public ldmz() { info = new OpInfo( "LD", "Load Indirect From Data Space to Register using Index Z",
            new Regex( @"1001000\d{5}0010", RegexOptions.Compiled ) ); }
