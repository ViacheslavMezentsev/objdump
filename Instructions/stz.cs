...
namespace objdump.Instructions {
    ...
    // 1000 001r rrrr 0000
    public class stz: IInstruction {

        public OpInfo info;
        public OpInfo OpInfo { get { return info; } }

        public stz() { info = new OpInfo( "ST", "Store Indirect From Register to Data Space using Index Z",
            new Regex( @"1000001\d{5}0000", RegexOptions.Compiled ) ); }
