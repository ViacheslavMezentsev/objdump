...
namespace objdump.Instructions {
    ...
    // 0000 0011 1ddd 1rrr
    public class fmulsu: IInstruction {

        public OpInfo info;
        public OpInfo OpInfo { get { return info; } }

        public fmulsu() { info = new OpInfo( "FMULSU", "Fractional Multiply Signed with Unsigned",
            new Regex( @"000000111\d{3}1\d{3}", RegexOptions.Compiled ) ); }
