...
namespace objdump.Instructions {
    ...
    // 1001 001r rrrr 1010
    public class stmy: IInstruction {

        public OpInfo info;
        public OpInfo OpInfo { get { return info; } }

        public stmy() { info = new OpInfo( "ST", "Store Indirect From Register to Data Space using Index Y",
            new Regex( @"1001001\d{5}1010", RegexOptions.Compiled ) ); }
