...
namespace objdump.Instructions {
    ...
    // 1001 000d dddd 1110
    public class ldmx: IInstruction {

        public OpInfo info;
        public OpInfo OpInfo { get { return info; } }

        public ldmx() { info = new OpInfo( "LD", "Load Indirect from Data Space to Register using Index X",
            new Regex( @"1001000\d{5}1110", RegexOptions.Compiled ) ); }
