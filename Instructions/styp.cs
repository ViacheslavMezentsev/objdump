...
namespace objdump.Instructions {
    ...
    // 1001 001r rrrr 1001
    public class styp: IInstruction {

        public OpInfo info;
        public OpInfo OpInfo { get { return info; } }

        public styp() { info = new OpInfo( "ST", "Store Indirect From Register to Data Space using Index Y",
            new Regex( @"1001001\d{5}1001", RegexOptions.Compiled ) ); }
        ...
        public string Disassemble( List< Record > list, ref int counter ) {
            ...
            try {
                ...
                // Параметры.
                op += String.Format( "Y+, R{0}", Rr ).PadRight( Program.CommentsPad, ' ' );
